                        ...
                        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <h3 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 19px; line-height: 27px; color: #333333; font-weight: normal;">Veuillez vous connectez à votre espace pour aborder votre inscription grâce à ces coordonées:</h3>
                                    <p style="margin: 0;">Login : <span style="color:#073d6d">{{$username}}</span></p>
                                    <p style="margin: 0;">Mot de passe : <span style="color:#073d6d">{{$password}}</span></p>

                        ...
                        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <h1 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 24px; line-height: 27px; color: #333333; font-weight: normal;">Modification de votre mot de passe</h1>
                                    <h3 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 19px; line-height: 27px; color: #333333; font-weight: normal;">Vous venez de déclarer que vous avez oublié votre mot de passe, afin de le modifier entrez le token suivant :</h3>
                                    <p style="margin: 0;">Token : <span style="color:#073d6d">{{$token}}</span></p>
                                     <p style="color:#e20a0a;">*Si vous n'avez rien déclaré, vous pouvez toute fois ignoré cette email. (Ce token ne tient qu'une heure)</p>
                                </td>
                            </tr>

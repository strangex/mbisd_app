                        ...
                        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <h1 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 24px; line-height: 27px; color: #333333; font-weight: normal;">Une email vient d'être envoyé par <span style='color:#087fe5'>{{$fullName}}</span>; Avec le contenu suivant:</h1>
                                    <h3 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 19px; line-height: 27px; color: #333333; font-weight: normal;">{{$content}}</h3>
                                    <h3 style='padding-top: 10%; font-size: 17px; color:#6b6262'>Si vous désirez contacter cette personne vous pouvez également utiliser ce numéro <span style='color:#0c5c7d; font-size:17px'>{{$number}}</span></h3>
                                </td>
                            </tr>
